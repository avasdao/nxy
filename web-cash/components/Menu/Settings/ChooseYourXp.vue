...
<template>
    <main>
        ...
        <div class="mt-3 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
            ...
            <label aria-label="Nexa Core" aria-description="Last activity was an hour ago to 621 users" class="col-span-2 relative flex cursor-pointer rounded-lg border border-gray-300 bg-white p-4 shadow-sm focus:outline-none">
