        ...
        <div class="relative px-4 sm:px-6 lg:px-8">
            <div class="text-lg max-w-prose mx-auto">
                <h1>
                    ...
                    <span class="mt-2 block text-5xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-6xl">
                        NEXA Pay
                    </span>
                </h1>

                <p class="mt-8 text-xl text-gray-500 leading-8">
                    Modenero Corp, lead by <a href="javascript://" class="text-indigo-500 font-medium hover:underline">Shomari Prince</a>, proposes to complete the development of the this BUIP.
            ...
            <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
                <p>
                    In 2020, I built Nito Cash, a web-wallet built for Bitcoin Cash (BCH).
                ...
                <h2 class="text-3xl text-green-500">Our Software Stack</h2>

                <p>
                    React Native is the leading cross-platform develpoment toolkit for native mobile applications.
