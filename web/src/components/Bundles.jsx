...
const plans = [
    {
        name: 'My 1st Space',
        featured: false,
        price: { Monthly: '1,000+ $NXY', Annually: '' },
        description:
    ...
    },
    {
        name: 'My 1st Economy',
        featured: false,
        price: { Monthly: '4,000+ $NXY', Annually: '' },
        description:
        ...
        features: [
            'Everything included in 1st Space',
            'Multi-layered encryption',
            'One tip every hour',
    ...
    },
    {
        ...
        features: [
            'Everything included in 1st Economy',
            'Automated market maker trading',
            'PoW mining and/or PoS rewards',
    ...
    return (
        ...
        >
            ...
            >
                ...
                <span className="ml-4 text-sky-500 text-2xl font-medium tracking-wider">
                    {name}
                </span>
            </h3>
            <p
